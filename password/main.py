from password.lib.directory.essentials import lin, generate_password
import pickle
import os
...
def main():
    ...
    try:
        ...
        enter = input('''Select the options that you want in your password! (default: 1 2 3 4):
1 - Uppercase Letters
2 - Lowercase Letters
3 - Numbers
4 - Symbols
